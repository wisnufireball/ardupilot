...
const AP_Param::GroupInfo RangeFinder::var_info[] = {
    ...
    // @Values: 0:None,1:Analog,2:MaxbotixI2C,3:LidarLiteV2-I2C,5:PX4-PWM,6:BBB-PRU,7:LightWareI2C,8:LightWareSerial,9:Bebop,10:MAVLink,11:uLanding,12:LeddarOne,13:MaxbotixSerial,14:TeraRangerI2C,15:LidarLiteV3-I2C,16:VL53L0X,17:SRF02I2C
    // @User: Standard
...
void RangeFinder::detect_instance(uint8_t instance, uint8_t& serial_instance)
{
    ...
    case RangeFinder_TYPE_MBI2C:
        ...
        break;
    case RangeFinder_TYPE_SRF02I2C:
        if (!_add_backend(AP_RangeFinder_SRF02I2C::detect(state[instance],
                                                          hal.i2c_mgr->get_device(1, AP_RANGE_FINDER_SRF02I2C_DEFAULT_ADDR)))) {
            _add_backend(AP_RangeFinder_SRF02I2C::detect(state[instance],
                                                         hal.i2c_mgr->get_device(0, AP_RANGE_FINDER_SRF02I2C_DEFAULT_ADDR)));
        }
        break;
